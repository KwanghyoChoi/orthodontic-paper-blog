...
1. **논문 커버 (Page 1)** - 반드시 크롭
   - 용도: 대표이미지(featured_image) + "원논문 소개" 섹션
   - 크롭 범위: 제목, 저널명, 저자, 초록 상단 포함

2. **핵심 Figure들** - 선별하여 크롭
   - PRISMA diagram, Forest plot, 차트, 다이어그램 등
   - 블로그 본문에 삽입
...
result:
  ...
  paper_cover:
    source_page: 1
    cropped_file: "paper_cover.png"
    crop_box: [50, 50, 1190, 850]
    usage:
      - featured_image  # 대표이미지
      - 원논문_소개_섹션  # "원논문 소개" 섹션에 삽입
